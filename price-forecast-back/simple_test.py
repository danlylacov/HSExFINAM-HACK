...
def simple_test():
    ...
    # Тестовые данные (только одна свеча)
    test_data = {
        "params": [
            {
                "ticker": "AFLT",
    ...
    print("🚀 Простой тест нового бэкенда")
    print("=" * 40)
    ...
    try:
        ...
        # Тестируем предсказания (только одну свечу)
        print("\n2. Тестирование предсказания одной свечи...")
        
        # Создаем простой запрос для одной свечи
        simple_request = {
            "params": test_data["params"][:1]  # Только одна свеча
        }
        ...
        if response.status_code == 200:
            ...
            # Анализируем первое предсказание
            ...
            last_close = test_data['params'][0]['close']
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("✅ Новый бэкенд с моделью доходностей работает корректно!")
    else:
        print("\n💥 Тест не пройден!")
