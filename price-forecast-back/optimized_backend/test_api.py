#!/usr/bin/env python3
"""
Тест оптимизированного бэкенда
"""
...
def test_optimized_backend():
    """Тестирование оптимизированного бэкенда"""
    ...
    print("🚀 Тестирование оптимизированного бэкенда")
    print("=" * 50)
    ...
    try:
        ...
        print("❌ Не удается подключиться к API. Убедитесь, что сервер запущен на порту 8010.")
        return False
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("✅ Оптимизированный бэкенд работает корректно!")
    else:
        print("\n💥 Тест не пройден!")
